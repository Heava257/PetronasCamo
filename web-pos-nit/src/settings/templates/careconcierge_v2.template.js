/**
 * Care Concierge V2 Template
 * Soft, rounded UI with Blue accents and pill-shaped elements 
 */
export const careConciergeV2Template = {
    id: 'careconcierge_v2',
    name: 'Care Concierge V2',
    description: 'Friendly, rounded UI with pill navigation (Variant 2)',
    preview: {
        primaryColor: '#2563eb',
...
export default careConciergeV2Template;
