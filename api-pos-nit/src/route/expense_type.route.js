...
module.exports = (app) => {
  app.get("/api/expense_type", validate_token("expanse_type.view"), getExpenseTypes);
  ...
  app.get("/api/oil_expense_total/:user_id", validate_token("expanse_type.view"), getOilExpenseTotal);
};