...
module.exports = (app) => {
  app.get("/api/expense_type", validate_token("expanse_type.getlist"), getExpenseTypes);
  ...
  app.get("/api/oil_expense_total/:user_id", validate_token("expanse.view"), getOilExpenseTotal);
};
